...
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
		{\raggedleft
			\begin{tabularx}{\textwidth}{l@{\,\,\raggedright~}L} % verbreiterter Abstand zwischen Feldern wurde gewünscht
				\normalfont Dozent:&\normalfont Dr. Bla Blub\\
				\normalfont Seminar:&\normalfont xxxx xxx xx und xxx \newline xxx xxx\\
				\\
				\normalfont Name:&\normalfont Marie Musterfrau\\ 
				\normalfont Studienfach:&\normalfont Sozialwissenschaften (Monobachelor)\\
				\normalfont Matrikelnummer:&\normalfont xxxx\\
				\normalfont Emailadresse:&\normalfont xxx.xxx@proivder.de\\
				\\
				\normalfont Berlin, der 30. März 2017
				\vspace{-2.5cm}
			\end{tabularx}}
